...
\copy (SELECT name, ST_Transform(way,4326) FROM parcels_v) TO '/tmp/parcels.copy' DELIMITER ',' CSV HEADER;
\copy (SELECT name, ST_Transform(way,4326) FROM   roads_v) TO '/tmp/roads.copy'   DELIMITER ',' CSV HEADER;
