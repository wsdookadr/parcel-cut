...
\copy (SELECT name, ST_Transform(way,4326) FROM planet_osm_polygon WHERE tags->'leisure'='park' AND name LIKE '%Herăstrău%') TO '/tmp/parcels.copy' DELIMITER ',' CSV HEADER;
SET search_path = public, plan;
\copy parcel (name, way) FROM '/tmp/parcels.copy' DELIMITER ',' CSV HEADER;
-- TODO: need to have road samples here
